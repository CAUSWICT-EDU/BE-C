...
GuessChecker.java = Compares the number entered by the user and the random number generated by the {NumberGenerator.java} module. Displays the number of correct positions, number of correct numbers and the error message. Also displays the remaining guesses.

Main.java = Main module that executes all the code together.

NumberGenerator.java = Generates random number.

Player.java = Interacts with the player and allows the player to enter their guesses. 
